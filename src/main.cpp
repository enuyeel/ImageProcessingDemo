...
namespace global {
  ...
  GLint operationIndex = -1; //Should be compatible with GLSL int (32 bits)
...
static void draw(double deltaTime)
{
  ...
  if (!global::frame.empty())
  {
    ...
    scaleTexture(global::sourceTexture, global::destinationTexture, global::windowWidth, global::windowHeight);
